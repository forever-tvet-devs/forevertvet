...
export const posts: NewsPost[] = [
  ...
  },
  {
    ...
    body: [
      ...
      "The total programme fee covers tuition, lab usage, learning materials, internship placement, the national RQF certification exam, and certificate issuance. ",
