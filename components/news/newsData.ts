...
export const posts: NewsPost[] = [
  {
    ...
    excerpt: "The latest cohort of heavy machinery and road construction graduates have secured positions with leading companies, with starting salaries ranging from 100,000 to 500,000 RWF per month.",
    imageSrc: "/images/image1.png",
    featured: true,
    body: [
      "Forever Tvet Institute is proud to announce that the majority of graduates from the 2025 Heavy Machinery Operation and Road Construction Technology programmes have secured formal employment within six months of completing their studies. Companies recruiting this cohort include some of Rwanda's most active infrastructure contractors and Chinese construction firms operating on national road and building projects.",
      ...
      "Students interested in the Heavy Machinery and Road Construction programmes for the 2026 intake can apply through the school's online application portal. Places are limited, and preference is given to early applicants.",
    ],
  },
  {
    ...
    readTime: "3 min read",
    title: "New Equipment Partnership Strengthens Heavy Machinery Training Programme",
  ...
  },
  {
    ...
    excerpt: "Applications are now being accepted for the 2026 intake. Places are limited across all five programmes — Heavy Machinery, Land Survey, Industrial Electricity, Road Construction, and Computer Engineering.",
    imageSrc: "/images/SolarPanelsTechnologyImage.png",
    body: [
      "Forever Tvet Institute has officially opened applications for the 2026 academic year intake. All five nationally recognised vocational programmes are accepting applications — Heavy Machinery Operation, Land Survey & Geomatics, Industrial Electricity, Road Construction Technology, and Computer Engineering.",
      ...
      "The minimum entry requirement for all programmes is a secondary school leaving certificate (Senior 6 or equivalent). Level 4 programmes — Industrial Electricity and Computer Engineering — have additional academic prerequisites. Full entry requirements are published on the school's Requirements page.",
  ...
  },
  {
    ...
    body: [
      "Forever Tvet Institute hosted its annual Career Fair on 28 February 2026, bringing together more than 20 employers from sectors spanning construction, industrial electricity, IT and networking, and land surveying. The event, held in the school's main hall, was open to all Intake 1 students as well as members of the public interested in understanding the career landscape for TVET graduates.",
      ...
      "By the end of the day, at least six employers had offered conditional internship placements or indicated strong interest in hiring specific students following graduation. Three students from the Industrial Electricity programme received verbal offers of internship placements beginning in May, ahead of the school's formal Phase 3 internship schedule.",
  ...
  },
  {
    ...
    readTime: "3 min read",
    title: "Land Survey Students Achieve 100% Pass Rate in National RQF Examinations",
    excerpt: "All enrolled Land Survey & Geomatics students passed their Rwanda Qualifications Framework examinations in the December 2025 sitting — the third consecutive year of a perfect pass rate for the program.",
    imageSrc: "/images/LandSurveyingLecturer.jpg",
    body: [
      "For the third consecutive year, every enrolled student in the Land Survey & Geomatics programme at Forever Tvet Institute has achieved a passing grade in the Rwanda Qualifications Framework (RQF) national certification examinations. The December 2025 sitting maintained the programme's extraordinary record — a 100% pass rate across three successive years.",
      ...
      "The results reinforce Forever Tvet Institute's position as one of the leading TVET providers for land survey training in Rwanda. Students interested in the Land Survey & Geomatics programme can apply for the 2026 intake through the school's online portal.",
    ],
  },
  {
  ...
  },
  {
    ...
    readTime: "3 min read",
    title: "Computer Engineering Programme Now Incorporates Cisco Networking Curriculum",
    excerpt: "Forever Tvet Institute's Computer Engineering programme has integrated Cisco networking modules into its curriculum, giving students industry-recognised networking skills alongside their RQF qualification.",
    imageSrc: "/images/image2(ElecticalControlCabinate).png",
    body: [
      "Forever Tvet Institute has integrated Cisco networking curriculum modules into the Computer Engineering programme, effective from the 2026 academic year. The integration means that Computer Engineering students will now study structured network fundamentals, IP addressing, routing concepts, and network troubleshooting as part of their programme — skills directly aligned with what employers in IT infrastructure, telecommunications, and systems integration are actively hiring for.",
      "The Cisco curriculum is delivered alongside the existing RQF-accredited Computer Engineering content, not as a replacement. Students complete both streams in parallel, with the Cisco modules occupying dedicated lab sessions during Phase 2 and Phase 3 of the programme. Hardware for the sessions — including Cisco routers, switches, and patch panels — is already installed in the Computer Engineering Lab.",
      "The head of the Computer Engineering programme explained the motivation behind the integration: 'Rwanda's digital economy is growing fast. Companies need people who can set up networks, not just fix laptops. Adding Cisco content means our graduates can do both — and that makes them significantly more hireable.'",
      "Computer Engineering students who successfully complete both the RQF examinations and the Cisco module assessments will receive their national TVET certificate alongside a record of achievement for the Cisco content. This dual-credential approach strengthens the graduate's CV without extending the duration of the programme.",
    ],
  },
  {
