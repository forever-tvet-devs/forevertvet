...
// Show the 3 most recent articles on the landing page
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid md:grid-cols-3 gap-6">
          {latestPosts.map((post, i) => (
            <FadeInBlur key={post.slug} delay={300 + i * 150}>
              <Link href={`/news/${post.slug}`} className="group block bg-white rounded-2xl border border-gray-100 overflow-hidden hover:shadow-lg transition-all duration-300">
