...
const contactDetails = [
  { icon: MapPin, label: "KG 15 Ave, Kigali, Rwanda",              href: null },
  { icon: Phone,  label: "+250 788 000 000",                        href: "tel:+250788000000" },
  { icon: Mail,   label: "info@foreverinternational.ac.rw",         href: "mailto:info@foreverinternational.ac.rw" },
  { icon: Clock,  label: "Mon – Fri, 7:30 AM – 4:30 PM",           href: null },
];
